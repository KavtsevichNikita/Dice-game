...
document.querySelector('.btn-roll').addEventListener('click', function btn() {
    if(gamePlaying){
        ...
        document.getElementById('dice-1').src = 'src/img/dice-' + dice1 + '.png'; //img change
        document.getElementById('dice-2').src = 'src/img/dice-' + dice2 + '.png'; //img change
...
document.querySelector('.btn-hold').addEventListener('click', function () {
    ...
    if(gamePlaying){
        ...
        let winningScore;
        //Underfined 0,null "" are CORCED to false
